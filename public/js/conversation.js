    ...
    textArray.forEach(function (currentText) {
      if (currentText) {
        var messageJson = {
            ...
            'tagName': 'div',
            'classNames': [(isUser ? 'message' : 'respleft'), 'latest', ((messageArray.length === 0) ? 'top' : 'sub')],
            'children': [{
              // <div class='message-inner'>
              'tagName': 'img',
              'classNames': ['miniwhatson'],
              'attributes': [{
                'name': 'src',
                'value': 'img/whatson-boneco.png'
        }]
            }, {'tagName': 'div',
              'classNames': ['message', (isUser ? 'from' : 'to'), 'ready'],
              'text': currentText
      }]
...
setAttribute('src', 'https://www.ibm.com/developerworks/community/blogs/Marc/resource/BLOGS_UPLOADED_IMAGES/WEXconv.jpg');
}
const imagemWhatson = document.querySelector('.miniwhatson');
putImage(imagemWhatson);
  ...
  function scrollToChatBottom() {
    var scrollingChat = document.querySelector('#messages');
